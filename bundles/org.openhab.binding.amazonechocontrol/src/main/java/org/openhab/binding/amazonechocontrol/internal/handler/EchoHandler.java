            ...
            if (channelId.equals(CHANNEL_BLUETOOTH)) {
                ...
                if (command == OnOffType.ON) {
                    ...
                    if (state != null && (bluetoothId == null || bluetoothId.isEmpty())) {
                        List<PairedDevice> pairedDeviceList = state.pairedDeviceList;
    ...
    public void updateState(AccountHandler accountHandler, @Nullable Device device,
        ...
        try {
            ...
            if (bluetoothState != null) {
                ...
                List<PairedDevice> pairedDeviceList = bluetoothState.pairedDeviceList;
                for (PairedDevice paired : pairedDeviceList) {
                    String pairedAddress = paired.address;
            ...
            if (mediaState != null) {
                List<QueueEntry> queueEntries = mediaState.queue;
